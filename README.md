...
<div class="container mt-4">
  <div class="row g-4">
    ...
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="tokyo.avif" class="card-img-top" alt="Tokyo">
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="usa.jpg" class="card-img-top" alt="Grand Canyon">
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="greece.avif" class="card-img-top" alt="Santorini">
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="switzerland.avif" class="card-img-top" alt="Swiss Alps">
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="peru.avif" class="card-img-top" alt="Machu Picchu">
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="italy.avif" class="card-img-top" alt="Venice">
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card shot-card">
        <img src="dubai.avif" class="card-img-top" alt="Dubai">
        <div class="card-body">
...
<footer class="mt-5">
  <h2 style="background-color: #1a3635; color: white; text-align: center; font-size: 18px; font-family: 'Trebuchet MS', sans-serif;">
    Designed and developed by Dharshini J
  </h2>
</footer>
...
![alt text](<Screenshot 2025-11-17 094154.png>)
## RESULT:
